...
urlpatterns = [
    ...
    url(r'^(?i)multiaxial/multiplasticity/$',    views.my_multiplasticity,        name='multiplasticity'   ),
    url(r'^(?i)multiaxial/multicycle/$',         views.my_multicycle,             name='multicycle'   ),
    url(r'^(?i)multiaxial/multidamage/$',        views.my_multidamage,            name='multidamage'   ),
    url(r'^(?i)multiaxial/multiresults/$',        views.my_multiresults,            name='multiresults'   ),
